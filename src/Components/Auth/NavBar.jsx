...
function NavBar({ currentUser, logOut }) {
  ...
  return (
    <nav
      className="navbar navbar-expand navbar shadow"
      style={{ backgroundColor: "white" }}
    >
      <div className="navbar-nav container mx-4 ">
        <li className="nav-item">
          {currentUser ? (
            ...
            <Link to={"/notloggedin"} className="nav-link">
              <svg
                class="_8pSp-"
                viewBox="0 0 559 825"
                height="49"
      ...
      {currentUser ? (
        <div className="navbar-nav ms-auto">
          <li className="nav-item mx-lg-4 me-4">
          ...
          <li className="nav-item mx-lg-4 me-4">
            <a href="/login" className="nav-link" onClick={logOut}>
            <button className="addBtn">Logout</button>
            </a>
          </li>
        </div>
      ) : (
